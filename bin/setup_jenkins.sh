...
# oc secrets new-basicauth gitea-secret --username=iaugusto-alltechsolucoes.com.br --password=thequick -n ${GUID}-jenkins
oc create secret generic gitea-secret --from-literal=username=rsales-redhat.com --from-literal=password=homework2019 -n ${GUID}-jenkins
