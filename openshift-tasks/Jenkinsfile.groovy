// Set your project Prefix using your demo
def prefix      = "demo"
  ...
  stages {
    ...
    stage('Code Analysis') {
      steps {
        ...
        sh "${mvnCmd} sonar:sonar -Dsonar.host.url=http://sonarqube-${prefix}-sonarqube.apps.cluster-c9e6.c9e6.example.opentlc.com/ -Dsonar.projectName=${JOB_BASE_NAME} -Dsonar.projectVersion=${devTag}"
      }
    }
